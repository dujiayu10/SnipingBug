...
//		webtest.open("http://127.0.0.1/home.php/rent");
//		String title = webtest.getText("xpath=/html/body/div/div[3]/div[1]/ul/li[3]/div[3]/p[1]/a");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/ul/li[3]/div[3]/p[1]/a");
...
//		assertEquals(webtest.getUrl(), "http://127.0.0.1/home.php/rent");
//	}
//	
//	//No.32
//	@Test(priority = 5)
...
//	//No.33
//	@Test(priority = 6)
//	public void clearCondition() throws InterruptedException {
//		webtest.open("http://127.0.0.1/home.php/rent");
...
//		webtest.open("http://127.0.0.1/home.php/rent");
//		webtest.click("/html/body/div/div[3]/div[1]/ul/div/div/ul/li[5]/a");
//		///html/body/div/div[3]/div[1]/ul/li[1]
//		//html/body/div/div[3]/div[1]/ul/li[1]/div[1]/span
//		List<String> price = new ArrayList<String>();
//		for(int i =1;i<=12;i++) {
//			String xpath = "xpath=/html/body/div/div[3]/div[1]/ul/li["+i+"]/div[1]/span";
//			price.add(webtest.getText(xpath));
...
//		webtest.open("http://127.0.0.1/home.php/rent");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/ul/div/div/ul/li[3]/a");
//		List<String> price = new ArrayList<String>();
//		for(int i =1;i<=12;i++) {
...
//		webtest.open("http://127.0.0.1/home.php/rent");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/ul/li[5]/div[2]/a/img");
...
//		Thread.sleep(1000);
//		webtest.click("xpath=//*[@placeholder=\"认证码\"]");
...
//		webtest.open("http://127.0.0.1/home.php/rent");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/div[1]/p[1]/span/a[14]");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/div[1]/p[2]/span/a[9]");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/div[1]/p[3]/span/a[10]");
//		webtest.click("xpath=/html/body/div/div[3]/div[1]/div[1]/p[5]/span/a[7]");
